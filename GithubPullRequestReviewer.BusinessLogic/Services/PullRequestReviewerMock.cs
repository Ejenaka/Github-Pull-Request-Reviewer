...
namespace GithubPullRequestReviewer.BusinessLogic.Services
{
    ...
    {
        public Task<ReviewResult> ReviewPullRequestAsync(long repositoryId, int pullRequestNumber)
        {
            ...
            return Task.FromResult(
                JsonSerializer.Deserialize<ReviewResult>(jsonResponse, new JsonSerializerOptions { PropertyNameCaseInsensitive = true }));
        }
    }
}
